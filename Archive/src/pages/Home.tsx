        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-slate-900">EN 837-1, IS:3624, EN 837 Certified</h3>
              <p className="text-slate-600">
...
/>
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 mb-4">
                  Utility, stainless steel, process, test, and precision gauges for all pressure measurement needs.
                </p>
                <Link
                  to="/products"
...
/>
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 mb-4">
                  Bi-metal, gas-filled, and all-angle thermometers for accurate temperature monitoring.
                </p>
                <Link
                  to="/products"
                  className="text-blue-900 font-semibold hover:text-blue-700 inline-flex items-center"
...
/>
              <div className="p-6">
                ...
                <p className="text-slate-600 mb-4">
                  Pulsation dampeners, snubbers, thermowells, and protective devices for optimal performance.
                </p>
                <Link
                  to="/products"
                  className="text-blue-900 font-semibold hover:text-blue-700 inline-flex items-center"
