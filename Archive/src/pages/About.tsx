        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border-l-4 border-blue-900 pl-6">
              ...
              <p className="text-lg text-slate-600">
                All our products are manufactured in strict adherence to EN 837-1, ANSI B 14.1, IS:3624 international standards, ensuring consistent quality, accuracy, and reliability. Our gauges undergo rigorous testing and quality control procedures to meet or exceed industry requirements.
              </p>
            </div>
